...
//        processRequest(request, response);
        ...
        request.getRequestDispatcher("/AddView.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
//        processRequest(request, response);
        String raw_paperid = request.getParameter("paperid");
        ...
        dao.setPaper(p);
        //
        String[] raw_authorids = request.getParameterValues("authorid");
        for (String raw_authorid : raw_authorids) {
            dao.setAuthorPaper(Integer.parseInt(raw_authorid), Integer.parseInt(raw_paperid));
        }
        request.getRequestDispatcher("/AddView.jsp").forward(request, response);
    }
