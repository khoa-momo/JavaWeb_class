...
public class AOutcome extends javax.swing.JFrame {
    ...
    public AOutcome() {
        ...
        String []header = {"Ship name","Battle name", "Result"};
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED), "Search Outcomes"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            List<Outcome> list = new OutcomeModel().getOutcomeByShipName(jTextField1.getText());
            for(Outcome x : list){
                tableModel.addRow(new Object[]{x.getShip(), x.getBattle(), x.getResult()});
            }
