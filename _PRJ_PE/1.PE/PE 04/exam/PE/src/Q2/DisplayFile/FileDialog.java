...
public class FileDialog extends javax.swing.JDialog {
    ...
    public FileDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        Parent pa = (Parent) parent;

        jTextField1.setText("Hello " + pa.returnUsername());
    }

    public String returnPathfile() {
    ...
    private void initComponents() {
        ...
        jTextField1.setBackground(new java.awt.Color(102, 230, 255));
        jTextField1.setFont(new java.awt.Font("sansserif", 1, 36)); // NOI18N
        jTextField1.setForeground(new java.awt.Color(193, 144, 241));
        jTextField1.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jTextField1.setText("Hello");

        jLabel1.setText("Path file:");

        jButton1.setText("Browsw");
        ...
        jCheckBox1.setText("show size");

        jCheckBox2.setText("show date");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(jTextField2.getText().isEmpty()){
            JOptionPane.showConfirmDialog(this, "Please fill the path file");
        }
        dispose();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //Tao doi tuong mo file, mot cua so con cho phep chon file trong may tinh
