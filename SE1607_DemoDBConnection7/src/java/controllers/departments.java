...
public class departments extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        //declare list and call func
        ArrayList<Department> deptList = dao.getAllDepartments();
        
        int page;//page num ?
        int numberpage = 1;//PageSize
        ...
        ArrayList<Department> paginglist = dao.getListByPage(deptList, start, end);
        
        
        //set Attribute
        request.setAttribute("deptList", paginglist);
