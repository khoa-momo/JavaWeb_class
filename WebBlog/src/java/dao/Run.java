...
public class Run {
    ...
    public static void main(String[] args) {
        ...
        int cid = 2;
        List<Entry> olist3 = dao.getAllEntriesByCategory(cid);
        for (Entry list : olist3) {
            System.out.println(list);
        }
        System.out.println("---------------------");            
//        List<Blog> olist2 = dao.getAllBlogs();
//        for (Blog list2 : olist2) {
//            System.out.println(list2);
//        }
//        System.out.println("---------------------"); 
        
        int bid = 2;
        List<Category> olist = dao.getAllBlogsByCategory(bid);
        for (Category list : olist) {
            System.out.println(list);
        }
        System.out.println("---------------------");        
...
//        List<Roll_Call_Books> olist3 = dao.getRollCallByCourse(1, date);
