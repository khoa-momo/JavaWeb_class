 ...
 * @author DELL
 */
@WebServlet(name = "adminAccountManager", urlPatterns = {"/RoomManager_AllAccount"})
public class adminAccountManager extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Account> allAccount = adao.getAllAccounts();
...
//        Account account = adao.getAccountByID(accName);
        ...
        if(account.equals("All")){
            ...
            List<Room> allRoom = rdao.getRoomByAccount(account);
            request.setAttribute("allRoom", allRoom);
        }
