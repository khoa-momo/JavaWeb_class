...
//        request.setAttribute("num", num);
        if (request.getSession().getAttribute("ename") != null) {
            ...
            List<Employee> paginglist = edao.getEmployeesByFillterPaging(ename, dateFrom, dateTo, esex, eposition, depid, page, PAGE_SIZE);
            int totalProducts = edao.getTotalEmployeeFillterPaging(ename, dateFrom, dateTo, esex, eposition, depid);
...
//            request.setAttribute("paginglist", paginglist);
            ...
            request.getSession().setAttribute("eposition", eposition);
